...
## 技术总结
- 全链路处理：八爪鱼RPA采集(图1)→五级清洗(图2)→GLM-4分析(图4)
- 工程指标：1.2秒响应延迟(采集+清洗+分析),MAPE=8.3%预测精度
- 核心发现：安全缺陷占51.2%(NOA辅助驾驶事故提及率27.4%),负面舆情占比63.8%
...
| 爆燃         | 321      | 安全缺陷     |  
| 驾驶         | 298      | 技术故障     |  
**维度占比**：安全相关51.2% + 驾驶相关16.1% = 核心问题67.3%  
<img width="800" src="./图6.png">  
